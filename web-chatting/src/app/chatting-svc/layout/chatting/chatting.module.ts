...
import {OutRoomPopupModule} from './component/popup/out-room-popup/out-room-popup.module';
...
@NgModule({
  ...
  imports: [CommonModule, BrowserModule, StreamAutocompleteTextareaModule,
    ...
    MoveRoomPopupModule, OutRoomPopupModule,
    FrendAcceptPopupModule, NgxSpinnerModule.forRoot({ type: 'ball-scale-multiple' })
  ],
  exports: [
    ChattingComponent,
  ],
